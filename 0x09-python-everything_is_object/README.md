...
In this project, I studied object instantiation,variable aliasing and object identifiers, types, and mutability.
The project involves a series of quiz-like questions which prompted the answers to be provided in
