# Python - Almost a circle Task -> Test Cases

In this project, I employed my Python skills in OOP
by coding three classes connected by multi-level inheritance.
I wrote my own test case suite using the `unittest` module to test the functionalities of the classes.

This involved utilizing the following Python tools:
* Import
* Exceptions
* Private attributes
* Getter/setter
