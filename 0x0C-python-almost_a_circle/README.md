...
In this project, I put into work my OOP Python skills
by creating three multi-level inherited classes to represent rectangles and squares. I wrote my
own test cases using the `unittest` module to test all functionality for each
class.

The multi-level classes involved utilizing these Python tools:
* Import
* Exceptions
...
* File Input/Output
* `args`/`kwargs`
* JSON and CSV for serialization/deserialization
* Private attributes
* Unittesting
