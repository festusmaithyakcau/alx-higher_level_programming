...
libraries to send and receive HTTP messages to URLs. I practiced sending `GET`
and `POST` requests, fetching JSON resources and interacting with APIs (GitHub API).
